...
export function AlcaldiaItem({ zona }: AlcaldiaItemProps) {
  ...
  return (
    <div data-testid="alcaldia-item" className="flex items-center justify-between px-4 py-3 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
      ...
      <span data-testid="risk-badge" className={cn("text-xs font-medium", config.color)}>
        {config.label}
      </span>
    </div>
  );
